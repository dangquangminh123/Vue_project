                    ...
                    <div class="preview col-md-6">
                        <div class="preview-pic tab-content">
                            <div class="tab-pane active" id="pic-1">
                                <img :src="require(`@/assets/images/${productInfo.image}.jpg`)" />
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    //     detailProdct.push(productData);
    //   });
    //   console.log(detailProdct);
    //   this.detailProdct = detailProdct;
    // },
    },
